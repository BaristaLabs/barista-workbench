...
export class SplitPane extends React.Component<SplitPaneProps, SplitPaneState> {
    ...
    public render() {
        ...
        let paneStyle: React.CSSProperties, paneStyle2: React.CSSProperties;
        switch (split) {
            case 'vertical': {
    ...
    private handleMouseMove(e: any) {
        const { allowResize, primaryPaneMinSize, onPaneResized, split } = this.props;
